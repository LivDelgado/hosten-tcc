...
import br.cefetmg.inf.hosten.model.persistence.jpa.dao.IUsuarioDAO;
import br.cefetmg.inf.hosten.model.persistence.jpa.domain.Cargo;
import br.cefetmg.inf.hosten.model.persistence.jpa.domain.Usuario;
...
public class UsuarioDAO implements IUsuarioDAO {
    ...
    public boolean atualiza(String id, Usuario usuarioNov)
        ...
        Cargo crgAnt = usuarioAnt.getCodCargo();
        Cargo crgNov = usuarioNov.getCodCargo();
