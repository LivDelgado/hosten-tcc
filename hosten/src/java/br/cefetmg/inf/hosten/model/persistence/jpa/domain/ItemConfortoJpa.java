...
public class ItemConfortoJpa implements Serializable {
    ...
    private final Set<CategoriaQuartoJpa> categorias = new HashSet<>();

    public ItemConfortoJpa() {
    }

    public ItemConfortoJpa(String coditem) {
        this.codItem = coditem;
    }

    public ItemConfortoJpa(String codItem, String desItem) {
        this.codItem = codItem;
    ...
    public Set<CategoriaQuartoJpa> getCategorias() {
        return categorias;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ItemConfortoJpa)) {
            return false;
        }
        ItemConfortoJpa other = (ItemConfortoJpa) object;
