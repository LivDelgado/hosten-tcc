...
public class ProgramaJpa implements Serializable {
    ...
    private final Set<CargoJpa> cargos = new HashSet<>();

    public ProgramaJpa() {
    }

    public ProgramaJpa(String codprograma) {
        this.codPrograma = codprograma;
    }

    public ProgramaJpa(String codprograma, String desprograma) {
        this.codPrograma = codprograma;
    ...
    public Set<CargoJpa> getCargos() {
        return cargos;
    }
    
    public void addCargo(CargoJpa cargo) {
        this.cargos.add(cargo);
        cargo.getProgramas().add(this);
    }
    
    public void removeCargo(CargoJpa cargo) {
    ...
    public boolean equals(Object object) {
        if (!(object instanceof ProgramaJpa)) {
            return false;
        }
        ProgramaJpa other = (ProgramaJpa) object;
