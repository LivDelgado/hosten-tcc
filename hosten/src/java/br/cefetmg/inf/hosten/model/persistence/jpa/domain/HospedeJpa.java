...
public class HospedeJpa implements Serializable {
    ...
    private List<HospedagemJpa> hospedagens = new ArrayList<>();

    public HospedeJpa() {
    }

    public HospedeJpa(String codcpf) {
        this.codCpf = codcpf;
    }

    public HospedeJpa(String codCpf, String nomHospede, String desTelefone, String desEmail) {
        this.codCpf = codCpf;
    ...
    public List<HospedagemJpa> getHospedagens() {
        return hospedagens;
    }

    public void setHospedagens(List<HospedagemJpa> hospedagens) {
        this.hospedagens = hospedagens;
    }

    public void addHospedagem(HospedagemJpa hospedagem) {
        hospedagem.setCodCpf(this);
        this.hospedagens.add(hospedagem);
    }

    public void removeHospedagem(HospedeJpa hospedeNov, HospedagemJpa hospedagem) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HospedeJpa)) {
            return false;
        }
        HospedeJpa other = (HospedeJpa) object;
