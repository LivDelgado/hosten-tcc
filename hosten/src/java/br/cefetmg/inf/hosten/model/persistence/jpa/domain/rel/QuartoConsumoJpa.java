...
@IdClass(br.cefetmg.inf.hosten.model.persistence.jpa.domain.embeddable.QuartoConsumoId.class)
@NamedQueries({
...
public class QuartoConsumoJpa implements Serializable {
    ...
    private ServicoJpa seqServico;

    @ManyToOne
    @JoinColumn(name = "codusuarioregistro", referencedColumnName = "codusuario")
    private UsuarioJpa codUsuarioRegistro;

    public QuartoConsumoJpa() {
    }

    public QuartoConsumoJpa(QuartoConsumoId id, short qtdConsumo, ServicoJpa seqServico, UsuarioJpa codUsuarioRegistro) {
    ...
    public ServicoJpa getSeqServico() {
        return seqServico;
    }

    public void setSeqServico(ServicoJpa seqServico) {
        this.seqServico = seqServico;
    }

    public UsuarioJpa getCodUsuarioRegistro() {
        return codUsuarioRegistro;
    }

    public void setCodUsuarioRegistro(UsuarioJpa codUsuarioRegistro) {
        this.codUsuarioRegistro = codUsuarioRegistro;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof QuartoConsumoJpa)) {
            return false;
        }
        QuartoConsumoJpa other = (QuartoConsumoJpa) object;
